...
> **Summary**: This dictionary operationalizes **Digital Capability for Life Outcomes (DCLO)** as a higher-order formative construct.  
Use this as the working mapping before finalizing exact `resource_id` selections.

- **Source**: project:docs/dclo-indicator-mapping.md
- **Ingested**: 20260403T102018Z
- **Tags**: dclo, indicators, mapping
- **Category**: data
...
- [[Data Engineering Link to Pipeline]]
- [[Digital Capability for Life Outcomes (DCLO)]]
- [[Domain balance]]
- [[Domain-Indicator Dictionary (Starter)]]
- [[Dual-Track Note (Country Comparative)]]
- [[Formative by construction]]
- [[Measurement Design Decisions]]
- [[Missing Data Rules]]
- [[Next File to Build]]
- [[Normalization and Sign Rules]]
...
- [[Unit of Analysis]]
- [[Weighting and Aggregation (Initial)]]
- [[higher = better capability/outcome]]
