...
> **Summary**: This file classifies indicators for country-year DCLO into `core_formative`, `context_only`, or `exclude` using balanced gates.

- **Source**: project:docs/dpi-indicator-intake.md
