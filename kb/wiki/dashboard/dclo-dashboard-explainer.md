...
> **Summary**: This dashboard presents the **Digital Capability for Life Outcomes (DCLO)** index in two tracks:

- **Source**: project:docs/dashboard-explainer.md
...
- [[Causal Evidence]]
- [[Country-year comparative track]]
- [[Data sources in this build]]
