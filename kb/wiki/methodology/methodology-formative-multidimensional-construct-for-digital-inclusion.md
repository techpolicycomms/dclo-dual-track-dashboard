...
> **Summary**: ## Construct Name and Definition

- **Source**: project:docs/methodology-formative-sem.md
- **Ingested**: 20260403T102018Z
- **Tags**: methodology, sem, formative
...
- [[Estimation and Diagnostics Protocol]]
- [[Evidence base:]]
- [[Formal research label:]]
- [[Guardrail:]]
- [[Key References (High-Quality Journals)]]
- [[Naming Recommendation]]
- [[Primary construct name:]]
- [[Reasoning:]]
- [[Required checks:]]
- [[SDG-Aligned Domain Architecture]]
