...
> **Summary**: This note documents the causal-evidence layer used alongside the DCLO measurement system.
The measurement layer and causal layer are deliberately separated:

- **Source**: project:docs/dclo-causal-methodology.md
- **Ingested**: 20260403T102018Z
- **Tags**: dclo, causal, econometrics
