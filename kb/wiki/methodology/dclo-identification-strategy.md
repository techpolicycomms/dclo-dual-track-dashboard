...
> **Summary**: Estimate whether prior-period digital capability is associated with subsequent service-related performance while reducing confounding from:

- **Source**: project:docs/dclo-identification-strategy.md
- **Ingested**: 20260403T102018Z
- **Tags**: dclo, causal, identification
