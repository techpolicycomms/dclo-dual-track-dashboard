...
> **Summary**: The latest DCLO release upgrades the framework from a score-only dashboard to a rigor-oriented measurement plus causal-evidence system.
All quality gates now pass across state, country, and causal tracks.

- **Source**: project:docs/dclo-results-brief.md
- **Ingested**: 20260403T102018Z
- **Tags**: dclo, results, findings
- **Category**: findings
