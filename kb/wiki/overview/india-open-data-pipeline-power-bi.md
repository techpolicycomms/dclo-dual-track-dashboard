...
> **Summary**: This project ingests datasets from India's National Open Data Portal (`data.gov.in`), builds analytics-ready tables, and prepares outputs for Power BI dashboards.
